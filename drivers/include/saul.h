...
enum {
    ...
    SAUL_SENSE_ID_FLOW,             /**< sensor: flow */
    SAUL_SENSE_ID_VOLUME,           /**< sensor: volume */
...
enum {
    ...
    SAUL_SENSE_FLOW         = SAUL_CAT_SENSE | SAUL_SENSE_ID_FLOW,          /**< sensor: flow */
    SAUL_SENSE_VOLUME       = SAUL_CAT_SENSE | SAUL_SENSE_ID_VOLUME,        /**< sensor: volume */
