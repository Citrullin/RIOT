 ...
 */
#define CC110X_HEADER_SIZE              2

/**
 * @brief Maximum (layer 2) payload size supported by the driver
 */
#define CC110X_MAX_PAYLOAD_SIZE         (CC110X_MAX_FRAME_SIZE - CC110X_HEADER_SIZE)


/**
 * @brief Size of a layer 2 address on CC110x transceivers
 */
#define CC110X_ADDR_SIZE                1
 ...
 */
typedef struct netdev_radio_rx_info cc110x_rx_info_t;

/**
 * @brief Layer 2 header using in CC110x frames
 *
