...
#define IL0373_CMD_BOOSTER_SOFT_START_CONTROL (0x06)
#define IL0373_CMD_DEEP_SLEEP_MODE (0x07)
...
#define IL0373_CMD_GET_STATUS (0x71)
#define IL0373_CMD_VCM_DC_SETTING (0x82)
#define IL0373_CMD_PARTIAL_WINDOW (0x90)
#define IL0373_CMD_ENTER_PARTIAL_MODE (0x91)
#define IL0373_CMD_LEAVE_PARTIAL_MODE (0x92)
