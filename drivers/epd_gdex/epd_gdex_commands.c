...
epd_gdex_command POWER_SETTING_PSR_START[1] = {
        { .command = 0x00, .read = 0x00, .data = 0x00 }
};

epd_gdex_command POWER_SETTING_PWR_START[1] = {
        { .command = 0x00, .read = 0x00, .data = 0x00 }
};

epd_gdex_command POWER_ON[1] = {
        { .command = 0x00, .read = 0x00, .data = 0x04 }
};

epd_gdex_command POWER_OFF[1] = {
        { .command = 0x00, .read = 0x00, .data = 0x02 }
};

epd_gdex_command DEEP_SLEEP[2] = {
        { .command = 0x00, .read = 0x00, .data = 0x07 },
        { .command = 0x00, .read = 0x00, .data = 0xA5 }
};

epd_gdex_command DISPLAY_REFRESH[1] = {
        { .command = 0x00, .read = 0x00, .data = 0x12 }
};
