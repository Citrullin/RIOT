...
static const ble_uuid128_t gatt_svr_svc_rw_door_lock_uuid
        = BLE_UUID128_INIT(0x35, 0xa3, 0xc7, 0x14, 0x3f, 0x03, 0x3e, 0xa1, 0xfc,
                           0x48, 0x37, 0xd1, 0xb3, 0x38, 0xce, 0x1b);

/* UUID = 1bce38b3-d137-48ff-a13e-033e14c7a335 */
static const ble_uuid128_t gatt_svr_svc_chr_w_ddid_uuid
...
static const struct ble_gatt_svc_def gatt_svr_svcs[] = {
    ...
    },
    {
        ...
        .characteristics = (struct ble_gatt_chr_def[]) { {
            /* Characteristic: Read/Write DDID */
            .uuid = (ble_uuid_t*) &gatt_svr_svc_chr_w_ddid_uuid.u,
        ...
        struct ble_gatt_access_ctxt *ctxt, void *arg)
{
    ...
    ble_uuid_t* write_ddid_uuid = (ble_uuid_t*) &gatt_svr_svc_chr_w_ddid_uuid.u;
    ...
    if (ble_uuid_cmp(ctxt->chr->uuid, write_ddid_uuid) == 0) {

        puts("access to characteristic 'w DDID (write)'");
